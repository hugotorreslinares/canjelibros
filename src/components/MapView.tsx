      ...
      <div className="relative overflow-hidden bg-[#f3f2f2] min-h-[500px] lg:min-h-[640px]">
        ...
        {users.map((u) => (
          <button
            ...
            className="absolute -translate-x-1/2 -translate-y-1/2 bg-transparent border-none p-0 grid justify-items-center gap-[6px]"
          >
        ...
        <div className="absolute left-[24px] bottom-[24px] bg-[#f8f4f4]/92 border border-[#201e1d]/16 rounded-[2px] px-[16px] py-[12px] max-w-[300px]">
